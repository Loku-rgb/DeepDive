...
import adminNavigation from '../../../../adminMenu-items';
import memberNavigation from '../../../../memberMenu-items';
class Navigation extends Component {
    ...
    returnMenuList = () =>{
        console.log("In Navigation",this.props.userType)
        if(this.props.userType==="admin"){
            return adminNavigation.items
        }
        else return memberNavigation.items
    } 
    ...
    render() {
        ...
        let navContent = (
            <div className="navbar-wrapper">
                ...
                <NavContent navigation={this.returnMenuList()} setUserLoginState = {this.props.setUserLoginState} />
            </div>
        );
